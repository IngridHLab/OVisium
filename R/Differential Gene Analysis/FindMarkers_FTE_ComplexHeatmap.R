...
FindMarkers_filter_combined_FTE <- function(data, feature.list, slot, test, out.name) {
...
FindAllMarkers_filter_combined_FTE <- function(data, slot, feature.list, test, out.name) {
